...
import { JEVIEWS, evalDir, git, run, workDir } from './lib.mjs';
...
writeFileSync(file, JSON.stringify({ meta: { repo: name, subset, questionVersion: qv, jeviewsCommit: commit, run: prev + 1 }, output: out }) + '\n');
